...
if(isset($_POST['register']))
{
	...
	if($validate->isRequired($field_array))
	{
         ...
         if($validate -> isValidEmail($data['email']))
         {
         	...
         	{
         		redirect('register.php','Your Passwords did not match','erroe');
         	}
         }
         else
         {
         	redirect('register.php','Please use a valid email address','erroe');
         } 

	}
	else
    {
        redirect('register.php','Please fill in all required fields','erroe');
    } 
